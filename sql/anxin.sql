...
(
    ...
    return_deliver_user_name     nvarchar(128) null comment '回寄人姓名',
    return_deliver_user_position nvarchar(512) null comment '回寄人省市区',
    return_deliver_user_address  nvarchar(512) null comment '回寄人地址',
    return_deliver_user_phone    nvarchar(64)  null comment '回寄人手机号',
    return_deliver_user_age      int           null comment '检测人年龄',
    return_deliver_user_time     nvarchar(512) null comment '回寄上门时间',
...
ALTER TABLE AdStructure
    ADD CONSTRAINT fk_ad_structure_ad_id
...
ALTER TABLE AdStructure
    ADD CONSTRAINT fk_ad_view_log_ad_id
        FOREIGN KEY (ad_id) REFERENCES Advertisement (id) on delete cascade;
...
ALTER TABLE Distribute_Invite_Relation
    ADD CONSTRAINT fk_relation_inviter_id
...
ALTER TABLE Distribute_Application
    ADD CONSTRAINT fk_dis_application_user_id
        FOREIGN KEY (user_id) REFERENCES User (user_id) on delete cascade;
...
ALTER TABLE Distribute_Product
    ADD CONSTRAINT fk_dis_product_product_id
...
ALTER TABLE Distribute_Order
    ADD CONSTRAINT fk_dis_order_order_id
...
ALTER TABLE Distribute_Withdraw
...
-- 初始化数据
-- 1 管理员账号
INSERT INTO anxin.`User` (user_id, account, password, name, `role`)
VALUES (1, 'admin', 'admin888', 'admin', 2);
-- 2 分销等级
INSERT INTO anxin.Distribute_Level (level_id, level_name, rate1, rate2, rate3)
VALUES (1, '一级分销等级', 0, 20, 10);
INSERT INTO anxin.Distribute_Level (level_id, level_name, rate1, rate2, rate3)
VALUES (2, '二级分销等级', 0, 20, 10);
INSERT INTO anxin.Distribute_Level (level_id, level_name, rate1, rate2, rate3)
VALUES (3, '三级分销等级', 0, 20, 10);
INSERT INTO anxin.Distribute_Level (level_id, level_name, rate1, rate2, rate3)
VALUES (100, '默认分销等级(如级数太多查不到等级自动使用此等级)', 0, 0, 0);
-- 3 本地多媒体
INSERT INTO anxin.Local_Media_Tag (id, tag_name)
VALUES (1, '未分组');
-- 4
INSERT INTO anxin.NickNameRepo(id, `type`, content)
VALUES (1, 1, '用户');
INSERT INTO anxin.NickNameRepo(id, `type`, content)
VALUES (2, 2, '默认');
